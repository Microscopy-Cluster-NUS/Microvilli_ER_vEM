...
- **Scripts/ROI_1, ROI_2, ROI_3/** — ImageJ macros for per-ROI cropping, Trainable Weka segmentation (classifier saved as `.model`), probability-map thresholding of structures (microvilli/tubules, ER, lipids, mitochondria), and export to Wavefront `.obj`.
